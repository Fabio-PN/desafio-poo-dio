...
- Separando itens necessários para o Git;
- Preparando o ambiente para a IDE estar vinculada ao GitHub;
- Criação de pastas para versionamento de código;
- Criando commits de arquivos conforme eles são inseridos na pasta versionamento.
